...
architecture Behavioral of temp_testbench is
    ...
    signal udp_hdr_out : std_logic_vector(63 downto 0);
	 ...
	 signal mac_hdr_len        : std_logic_vector(7 downto 0) := x"10";
...
begin
    ...
    uut: entity work.register_controller
		...
		dut: entity work.hdr_agg_sft_reg
        port map (
            clk         => clk,
            reset       => reset,
            enable      => enable,
    ...
    begin
        ...
        --wait for clk_period;
		  ...
		  --data  <= x"0000000000000001"; wait for clk_period;
		  --data   <= x"0000000000000002"; wait for clk_period;
		  --data  <= x"0000000000000003"; wait for clk_period;
		  --
		  --data  <= x"0000000000000004"; wait for clk_period;
		  --data   <= x"0000000000000005"; wait for clk_period;
		  --data  <= x"0000000000000006"; wait for clk_period;
		  --
		  --data  <= x"0000000000000007"; wait for clk_period;
		  --data   <= x"0000000000000008"; wait for clk_period;
		  --data  <= x"0000000000000009"; wait for clk_period;
		  --
		  --data  <= x"000000000000000A"; wait for clk_period;
		  --data   <= x"000000000000000B"; wait for clk_period;
		  --data  <= x"000000000000000C"; wait for clk_period;
		  --
		  --data  <= x"000000000000000D"; wait for clk_period;
		  --data   <= x"000000000000000E"; wait for clk_period;
		  --data  <= x"000000000000000F"; wait for clk_period;
